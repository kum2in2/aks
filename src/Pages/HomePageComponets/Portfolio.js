...
const Portfolio = () => {
  ...
  <div className="container aos-init aos-animate" data-aos="fade-up">
    ...
    <div
      ...
      data-aos="fade-up"
      data-aos-delay={200}
      style={{ position: "relative", height: 891 }}
    >
      <div
      ...
      <div
        ...
        style={{ position: "absolute", left: 0, top: 297 }}
      >
        <div className="portfolio-wrap">
          <img
      ...
      <div
        className="col-lg-4 col-md-6 portfolio-item filter-web"
        style={{ position: "absolute", left: 380, top: 297 }}
      >
        <div className="portfolio-wrap">
          <img
      ...
      <div
        className="col-lg-4 col-md-6 portfolio-item filter-app"
        style={{ position: "absolute", left: 760, top: 297 }}
      >
        <div className="portfolio-wrap">
          <img
      ...
      <div
        className="col-lg-4 col-md-6 portfolio-item filter-card"
        style={{ position: "absolute", left: 0, top: 594 }}
      >
        <div className="portfolio-wrap">
          <img
      ...
      <div
        className="col-lg-4 col-md-6 portfolio-item filter-card"
        style={{ position: "absolute", left: 380, top: 594 }}
      >
        <div className="portfolio-wrap">
          <img
      ...
      <div
        className="col-lg-4 col-md-6 portfolio-item filter-web"
        style={{ position: "absolute", left: 760, top: 594 }}
      >
        <div className="portfolio-wrap">
          <img
