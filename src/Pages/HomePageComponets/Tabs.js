...
const Tabs = () => {
  ...
  <div className="container aos-init aos-animate" data-aos="fade-up">
    ...
    <div className="tab-content">
        ...
        <div className="row">
          <div className="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
            ...
            <ul>
              ...
              <li>
                <i className="ri-check-double-line" /> Provident mollitia neque
                rerum asperiores dolores quos qui a. Ipsum neque dolor voluptate
                nisi sed.
              </li>
              <li>
                <i className="ri-check-double-line" /> Ullamco laboris nisi ut
      ...
      <div className="tab-pane active" id="tab-4">
        <div className="row">
          <div className="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
            <h3>
